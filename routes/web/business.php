...
Route::group(['roles' => ['seller', 'admin'], 'middleware' => ['auth', 'roles']], function () {
    ...
    Route::get('user/products/list', ['uses' => 'UsersProductsController@index', 'as' => 'users.products.list']);
    ...
    Route::post('products/change/status/{id}', ['uses' => 'ProductsController@changeStatus', 'as' => 'products.users.change_status']);
