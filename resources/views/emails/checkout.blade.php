...
<table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#f6f5f3" style="padding: 15px">
    <tr>
        <table width="600" cellpadding="0" cellspacing="0" border="0">
            ...
            <tr>
                <td>Вы оформили заказ на сайте {{url('/')}} в <b>{{$data['order']['created_at']}}</b></td>
            </tr>
            <tr>
            ...
            <table style="border-bottom: 1px solid #c3c3c3;" cellspacing="0" cellpadding="5" width="600" >
                ...
                <tr>
                    ...
                    <td style="border-left: 1px solid #c3c3c3;font-family: arial, helvetica, sans-serif;font-size: 10pt;vertical-align: top;padding: 3px;padding-top: 10px;">
                        <a href="{{$data['product']['full_url']}}" target="_blank" rel="noopener">{{$data['product']['name']}}</a>({{$data['product']['id']}})</td>
                </tr>
                <tr>
...
{{--<table width="800px">--}}
    ...
    {{--<tr style="border-bottom: 1px solid #d0d4d8"><td>Название:<strong><a href="{{$data['product']['full_url']}}">{{$data['product']['name']}}</a> ( {{$data['product']['id']}} )</strong></tr>--}}
