        ...
        <div class="panel-body cart-resume">
            ...
            @if (count($cart['details']) == 0)
                <div class="alert alert-warning text-center text-small">
                    ...
                    @endif
                    <p>&nbsp;</p>
                    <a class="btn btn-primary" href="{{ url('/') }}">{{trans('store.continue_shopping')}}</a>
                </div>
            @endif
            ...
            @if (count($cart['details']) > 0)
                <div class="row">
                    <div class="col-xs-12 col-md-7 col-lg-8 text-left text-small">
                       {{ trans('store.productsInCart') }} <span class="ng-cloak">[[totalItems]]</span>
                    </div>
                    ...
                    <div class="text-small col-lg-6">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                            <a ng-controller="ModalCtrl" ng-init='data={"data":"{{ $item["product"]["id"] }}"}' ng-click="modalOpen({templateUrl:'/modalDetailsProductCart',controller:'getDetailsProductInCart',resolve:'data'})">
                                <img class="thumbnail" src='{{ \App\Models\UserProduct::images($item->product)[0] }}' alt="{{ $item->product->mainProduct->name }}" height="150" width="150">
                            </a>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                            ...
                            <h6>
                                <a ng-controller="ModalCtrl" ng-init='data={"data":"{{ $item["product"]["id"] }}"}' ng-click="modalOpen({templateUrl:'/modalDetailsProductCart',controller:'getDetailsProductInCart',resolve:'data'})">
                                    {{ $item['product']->mainProduct->name}}
                                </a>
                            </h6>
                            <p>{{ trans('globals.producer').': '.$item->product->mainProduct->producer->name }}</p>
                        </div>
